...
const Footer = ({ isDark, showIcons }) => (
  <div className={classnames(`${footer}`, isDark ? `${footer}--dark` : "")}>
    <span className={`${footer}__copyright-text`}>Sarah Keast 2022</span>
    {showIcons ? (
      <div className={`${footer}__icon-container`}>
        <a
          className={`${footer}__icon-link`}
          href={DRIBBBLE}
          target="_blank"
          rel="noopener noreferrer"
        >
          <img className={`${footer}__icon`} src={Dribble}></img>
        </a>
        <a
          className={`${footer}__icon-link`}
          href={LINKEDIN}
          ...
          rel="noopener noreferrer"
        >
          <img className={`${footer}__icon`} src={LinkedIn}></img>
        </a>
        <a
          className={`${footer}__icon-link`}
          href={INSTAGRAM}
